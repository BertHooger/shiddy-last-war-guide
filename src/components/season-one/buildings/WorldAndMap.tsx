...
import ContentWithRightGallery from '@/components/functions/blocks/image/ContentWithRightGallery';
            ...
            <ContentWithRightGallery
                ...
                content={
                    <>
                        ...
                        <div className="bg-red-500 p-4 rounded-lg shadow-md mt-4"> {/* Bubble styling */}
