...
const IntroComponent = lazy(() => import("@/components/basics/squads/SquadFormationComponent"));
const TroopTypeCounterComponent = lazy(() => import("@/components/basics/squads/TroopTypeCounterComponent"))
const HeroExpAndSquadsComponent = lazy(() => import("@/components/basics/squads/HeroExpAndSquadsComponent"))

const Sections: Section[] = [
    { title: 'Intro', id: 'intro', component: IntroComponent },
    { title: 'Troop Types and Counters', id: 'trooptype', component: TroopTypeCounterComponent },
    { title: 'Hero Exp and Squads', id: 'expandsquad', component: HeroExpAndSquadsComponent },
];
